           ...
           <div class="row">
             ...
             @endif
               <div class="card">
                ...
                <h4>Permissions
                    <a href="{{url('permissions/create')}}" class="btn btn-primary float-end">Ajouter une permission</a>
                   </h4>
                </div>
               <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{url('permissions/'.$permission->id.'/delete')}}" class="btn btn-danger mx-2">Supprimer</a>
                            </td>
                        </tr>
                        @endforeach
                      </tbody>
