                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4>Rôles
                                    <a href="{{ url('roles/create') }}" class="btn  float-right">Ajouter un rôle</a>
                                </h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('roles/' . $role->id . '/give-permissions') }}" class="btn btn-success">
                                                    Ajouter/Modifier un rôle ou une permission
                                                </a>
                                                <a href="{{ url('roles/' . $role->id . '/edit') }}" class="btn-modify">Modifier</a>
                                                <a href="{{ url('roles/' . $role->id . '/delete') }}" class="btn-delete">Supprimer</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
